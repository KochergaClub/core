...
def serve_slides(path=os.environ['HOME'] + '/Google Drive/Rationality/Workshops/Секции'):
...
def prepare_folders(event_name):
    ...
    public_folder = create_folder(content_folder['id'], 'Материалы по прикладной рациональности')
