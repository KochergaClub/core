...
LIST_ID = '8b43e3793e' # https://us11.admin.mailchimp.com/lists/settings/defaults?id=428961, "Участники Воркшопов и Курсов"
SPREADSHEET_ID = '1mj-YsVklLtlFfy_04lZ5a0NX85iZ3O_IxsUehBeJiFg'

def get_mailchimp_date_group_category():
    response = kocherga.mailchimp.api_call('GET', f'lists/{LIST_ID}/interest-categories')
