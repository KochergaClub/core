...
На входе мы будем спрашивать имена, чтобы проверить, что все участники мероприятия зарегистрированы в боте. У незарегистрированных будет возможность сделать это в последний момент.
