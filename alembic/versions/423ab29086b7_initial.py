...
def upgrade():
    ...
    sa.Column('google_link', sa.String(length=1024), nullable=True),
    ...
    sa.Column('posted_fb', sa.String(length=1024), nullable=True),
    sa.Column('posted_timepad', sa.String(length=1024), nullable=True),
    sa.Column('posted_vk', sa.String(length=1024), nullable=True),
