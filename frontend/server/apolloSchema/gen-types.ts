...
export type ResolversTypes = {
  ...
  MyCmCustomer: ResolverTypeWrapper<MyCmCustomer>,
  MyCmOrder: ResolverTypeWrapper<MyCmOrder>,
  ID: ResolverTypeWrapper<Scalars['ID']>,
  MyEventsTicket: ResolverTypeWrapper<MyEventsTicket>,
...
export type ResolversParentTypes = {
  ...
  MyCmCustomer: MyCmCustomer,
  MyCmOrder: MyCmOrder,
  ID: Scalars['ID'],
  MyEventsTicket: MyEventsTicket,
...
export type StaffonlyDirectiveResolver<Result, Parent, ContextType = TContext, Args = {  }> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type AuthDirectiveResolver<Result, Parent, ContextType = TContext, Args = {   permission?: Maybe<Maybe<Scalars['String']>>,
  permissions?: Maybe<Maybe<Array<Scalars['String']>>>,
  authenticated?: Maybe<Maybe<Scalars['Boolean']>> }> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type MutationResolvers<ContextType = TContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  authAddUserToGroup?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationAuthAddUserToGroupArgs, 'group_id' | 'user_id'>>,
  authRemoveUserFromGroup?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationAuthRemoveUserFromGroupArgs, 'group_id' | 'user_id'>>,
  zadarmaSetMemberForPbxCall?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationZadarmaSetMemberForPbxCallArgs, 'member_id' | 'pbx_call_id'>>,
  ...
  staffUnfireMember?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationStaffUnfireMemberArgs, 'id'>>,
...
export type MyResolvers<ContextType = TContext, ParentType extends ResolversParentTypes['My'] = ResolversParentTypes['My']> = {
  ...
  user?: Resolver<ResolversTypes['AuthCurrentUser'], ParentType, ContextType>,
  membership?: Resolver<Maybe<ResolversTypes['MyCmCustomer']>, ParentType, ContextType>,
  tickets?: Resolver<Array<ResolversTypes['MyEventsTicket']>, ParentType, ContextType>,
  email_subscription?: Resolver<ResolversTypes['MyEmailSubscription'], ParentType, ContextType>,
};

export type MyCmCustomerResolvers<ContextType = TContext, ParentType extends ResolversParentTypes['MyCmCustomer'] = ResolversParentTypes['MyCmCustomer']> = {
  card_id?: Resolver<ResolversTypes['Int'], ParentType, ContextType>,
  ...
  orders?: Resolver<Array<ResolversTypes['MyCmOrder']>, ParentType, ContextType>,
};

export type MyCmOrderResolvers<ContextType = TContext, ParentType extends ResolversParentTypes['MyCmOrder'] = ResolversParentTypes['MyCmOrder']> = {
...
export type MyEventsTicketResolvers<ContextType = TContext, ParentType extends ResolversParentTypes['MyEventsTicket'] = ResolversParentTypes['MyEventsTicket']> = {
...
export type Resolvers<ContextType = TContext> = {
  ...
  MyCmCustomer?: MyCmCustomerResolvers<ContextType>,
  MyCmOrder?: MyCmOrderResolvers<ContextType>,
  ...
  MyEventsTicket?: MyEventsTicketResolvers<ContextType>,
...
export type DirectiveResolvers<ContextType = TContext> = {
  staffonly?: StaffonlyDirectiveResolver<any, any, ContextType>,
...
*/
export type IDirectiveResolvers<ContextType = TContext> = DirectiveResolvers<ContextType>;