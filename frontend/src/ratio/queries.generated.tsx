...
export type RatioTicketTypePromocodesFragment = (
  ...
  & { pageInfo: (
    ...
    & { node: (
      ...
      & Pick<Types.RatioPromocode, 'id' | 'code'>
    ) }
  )> }
);
