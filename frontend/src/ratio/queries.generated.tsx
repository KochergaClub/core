...
export type RatioPromocodeFragment = (
  ...
  & Pick<Types.RatioPromocode, 'id' | 'code' | 'discount' | 'discount_percent' | 'uses_max' | 'uses_count'>
);
...
export type RatioTrainingFragment = (
  { __typename: 'RatioTraining' }
  & Pick<Types.RatioTraining, 'id' | 'slug' | 'name' | 'date' | 'telegram_link' | 'tickets_count' | 'total_income' | 'discount_by_email' | 'discount_percent_by_email' | 'promocodes_count'>
  & { promocodes: (
    { __typename: 'RatioPromocodeConnection' }
    & RatioPromocodeConnectionFragment
  ), tickets: Array<(
