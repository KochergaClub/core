...
export type WagtailPageTypeQuery = (
  { __typename?: 'Query' }
  & { wagtailPage?: Types.Maybe<{ __typename: 'RatioSectionIndexPage' } | { __typename: 'RatioSectionPage' } | { __typename: 'RatioNotebookIndexPage' } | { __typename: 'RatioNotebookPage' } | { __typename: 'RatioPresentationIndexPage' } | { __typename: 'RatioPresentationPage' } | { __typename: 'ProjectIndexPage' } | { __typename: 'ProjectPage' } | { __typename: 'FreeFormPage' } | { __typename: 'BlogPostPage' } | { __typename: 'BlogIndexPage' } | { __typename: 'FaqPage' }> }
);
