...
import { ImageWithTextBlockFragment } from './blocks/ImageWithTextBlock/index.generated';
...
import { ImageWithTextBlockFragmentDoc } from './blocks/ImageWithTextBlock/index.generated';
...
export type AnyWagtailBlock_ImageWithTextBlock_Fragment = (
...
export const AnyWagtailBlockFragmentDoc: DocumentNode<AnyWagtailBlockFragment, unknown> = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AnyWagtailBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"WagtailBlock"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BasicTextBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"SectionHeaderBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BasicCardBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ColumnsBasicBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ColumnsButtonsBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ImageWithTextBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"EventsListBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BigContactsBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PhotoRibbonBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"MailchimpSubscribeBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"HeroFrontBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"HrBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"AnchorBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"FrontPartnersBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"FrontSocialLinksBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"LandingHeroBlock"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"LandingTextBlock"}}]}},...BasicTextBlockFragmentDoc.definitions,...SectionHeaderBlockFragmentDoc.definitions,...BasicCardBlockFragmentDoc.definitions,...ColumnsBasicBlockFragmentDoc.definitions,...ColumnsButtonsBlockFragmentDoc.definitions,...ImageWithTextBlockFragmentDoc.definitions,...EventsListBlockFragmentDoc.definitions,...BigContactsBlockFragmentDoc.definitions,...PhotoRibbonBlockFragmentDoc.definitions,...MailchimpSubscribeBlockFragmentDoc.definitions,...HeroFrontBlockFragmentDoc.definitions,...HrBlockFragmentDoc.definitions,...AnchorBlockFragmentDoc.definitions,...FrontPartnersBlockFragmentDoc.definitions,...FrontSocialLinksBlockFragmentDoc.definitions,...LandingHeroBlockFragmentDoc.definitions,...LandingTextBlockFragmentDoc.definitions]};