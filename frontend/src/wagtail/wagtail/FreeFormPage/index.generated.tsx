...
export const FreeFormPageFragmentDoc: DocumentNode<FreeFormPageFragment, unknown> = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"FreeFormPage"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"FreeFormPage"}},"directives":[],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CommonWagtailPage"},"directives":[]},{"kind":"Field","name":{"kind":"Name","value":"body"},"arguments":[],"directives":[],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"},"arguments":[],"directives":[]},{"kind":"Field","name":{"kind":"Name","value":"id"},"arguments":[],"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BasicTextBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"SectionHeaderBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BasicCardBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ColumnsBasicBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ColumnsButtonsBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"EventsListBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BigContactsBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"PhotoRibbonBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"MailchimpSubscribeBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"HeroFrontBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"HrBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"FrontPartnersBlock"},"directives":[]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"FrontSocialLinksBlock"},"directives":[]}]}}]}},...CommonWagtailPageFragmentDoc.definitions,...BasicTextBlockFragmentDoc.definitions,...SectionHeaderBlockFragmentDoc.definitions,...BasicCardBlockFragmentDoc.definitions,...ColumnsBasicBlockFragmentDoc.definitions,...ColumnsButtonsBlockFragmentDoc.definitions,...EventsListBlockFragmentDoc.definitions,...BigContactsBlockFragmentDoc.definitions,...PhotoRibbonBlockFragmentDoc.definitions,...MailchimpSubscribeBlockFragmentDoc.definitions,...HeroFrontBlockFragmentDoc.definitions,...HrBlockFragmentDoc.definitions,...FrontPartnersBlockFragmentDoc.definitions,...FrontSocialLinksBlockFragmentDoc.definitions]};