...
export const OnWatchmenScheduleUpdatesDocument: DocumentNode<OnWatchmenScheduleUpdatesSubscription, OnWatchmenScheduleUpdatesSubscriptionVariables> = dedupeFragments({ "kind": "Document", "definitions": [{ "kind": "OperationDefinition", "operation": "subscription", "name": { "kind": "Name", "value": "onWatchmenScheduleUpdates" }, "variableDefinitions": [], "directives": [], "selectionSet": { "kind": "SelectionSet", "selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "watchmenScheduleUpdates" }, "arguments": [], "directives": [], "selectionSet": { "kind": "SelectionSet", "selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "updated" }, "arguments": [], "directives": [] }] } }] } }] });
