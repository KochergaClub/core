...
import EventAnnouncements from '~/events/pages/components/EventAnnouncements';
import Registration from '~/events/pages/components/Registration';
...
EventPage.getInitialProps = async ({ store: { getState }, query }) => {
