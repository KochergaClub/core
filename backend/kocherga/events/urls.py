...
urlpatterns += [
    ...
    path(
        'event/<event_id>/image_from_url/<image_type>',
        views.events.ImageFromUrlView.as_view(),
    ),
    ...
    path(
        'events/<event_id>/image_from_url/<image_type>',
        views.events.ImageFromUrlView.as_view(),
    ),
...
# Public events
router.register(
    'public_events', views.events.PublicEventsViewSet, basename='public_events'
)
urlpatterns += [
...
urlpatterns += [
    path(
        'event_prototypes/<prototype_id>/tag/<tag_name>',
        views.event_prototypes.TagView.as_view(),
    ),
]
...
router.register(
    r'announcements/timepad',
    views.announcements.TimepadViewSet,
    basename='announcements-timepad',
)
router.register(
    r'announcements/vk', views.announcements.VkViewSet, basename='announcements-vk'
)
router.register(
    r'announcements/fb', views.announcements.FbViewSet, basename='announcements-fb'
)

old_announcement_patterns = [
    path(
        'timepad/event/<event__uuid>',
        views.announcements.TimepadViewSet.as_view({'post': 'announce'}),
    ),
    path(
        'vk/event/<event__uuid>',
        views.announcements.VkViewSet.as_view({'post': 'announce'}),
    ),
    path(
        'fb/event/<event__uuid>',
        views.announcements.FbViewSet.as_view({'post': 'announce'}),
    ),
]

router.register(
    r'event_feedbacks', views.feedback.FeedbackViewSet, basename='event-feedbacks'
)
...
urlpatterns += [
    ...
    path(
        'weekly-digest/current/mailchimp-draft',
        views.weekly_digest.r_post_mailchimp_draft,
    ),
