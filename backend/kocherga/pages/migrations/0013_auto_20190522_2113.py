                ...
                [
                    ...
                    (
                        ...
                        wagtail.core.blocks.RichTextBlock(
                            group='basic', icon='bold', label='Крупный текст'
                        ),
                    ),
                    (
                        'basic_paragraph',
                        wagtail.core.blocks.RichTextBlock(
                            group='basic', icon='doc-full', label='Обычный текст'
                        ),
                    ),
                    (
                        'columns_basic',
                    ...
                    (
                        ...
                        wagtail.core.blocks.static_block.StaticBlock(
                            group='various', icon='list-ul', label='Список событий'
                        ),
                    ),
                    (
                        'big_contacts',
                    ...
                    (
                        'photo_ribbon',
                        wagtail.core.blocks.ListBlock(
                            kocherga.pages.blocks.APIImageChooserBlock(),
                            group='various',
                            label='Лента фоток',
                        ),
                    ),
                    ...
                    (
                        ...
                        wagtail.core.blocks.StructBlock(
                            [
                                (
                                    'title',
                                    wagtail.core.blocks.CharBlock(label='Заголовок'),
                                ),
                                (
                                    'features',
                                    wagtail.core.blocks.ListBlock(
